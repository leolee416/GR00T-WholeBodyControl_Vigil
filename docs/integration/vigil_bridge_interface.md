...
| `gear_sonic/vigil_bridge/rollout_recorder.py` | `g1_debug` 实测状态录制、外部定位对齐和 NPZ 导出 |
...
| `capabilities.rollout_recording` | object/absent | real/MuJoCo backend 配置 recorder 时出现 |
